...
import frc.robot.commands.NOTDriveCommand;
...
public class RobotContainer {
  ...
  private final NOTDriveSubsystem m_NOTDriveSubsystem = new NOTDriveSubsystem();
  ...
  public RobotContainer() {
    ...
    m_NOTDriveSubsystem.setDefaultCommand(m_DriveCommand);
